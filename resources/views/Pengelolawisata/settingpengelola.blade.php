                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div id="div-1" class="accordion-body collapse in body">
                                    <form class="form-horizontal" method="POST" action="{{ route('saveprofilpengelola') }}"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="autosize" name="alamat" class="span6" required></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="autosize"
                                            ...
                                            <div class="controls">
                                                <input type="number" name="kontak" id="text1"
                                                    class="span6 input-tooltip"
                                                    data-original-title="Masukkan Kontak Perusahaan" data-placement="bottom"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="about" name="about" class="span6 ckeditor" required></textarea>
                                            </div>
                                        </div>
                                        <hr>
                                        <header>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="chzn-select span6 select2" tabindex="2"
                                                    ...
                                                    <option value="">
                                                        {{ GoogleTranslate::trans('Pilih Bank', session()->get('language') ?? 'id') }}
                                                    </option>
