                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div id="div-1" class="accordion-body collapse in body">
                                    <form class="form-horizontal" method="POST" action="{{ route('kategoripaketwisata.update', $data->id) }}"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="nama_paket" id="text1" class="span6 input-tooltip @error('nama_paket') is-invalid @enderror"
                                                    data-original-title="Masukkan Bidang Pekerjaan"
                                                    data-placement="bottom" value="{{ $data->nama_paket }}" />
                                                    @error('nama_paket')
