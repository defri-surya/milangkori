...
@section('title', 'Home | Admin Transaksi')
                                            ...
                                            @forelse ($data as $item => $value)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <a href="{{ route('showTransaksiAdmin', $value->id) }}"
                                                            class="btn detail"><i class="fas fa-eye"></i>
                                                            Detail
                                                        </a>
                                                        <form action="{{ route('deletetransaksi.delete', $value->id) }}" method="POST"
