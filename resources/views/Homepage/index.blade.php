...
@section('content')
    ...
    <div class="hero"
        style="background-image: url('{{ asset('assets') }}/frontend/images/image-tur1.jpg'); height: 85vh; background-repeat: no-repeat; background-size: cover; background-position: center">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4" style="margin-top: 15%" {{-- style="right: 10%" --}}>
                    <div class="intro-wrap title">
                        <h1>
                            <span class="d-block">
                                Local Guides, Local Wisdom<br>
                            </span>
                            <span class="d-block">
                                TRIPVENTURE
                            </span>
    ...
    <div class="untree_co-section" style="background-color: #eee">
        <div class="container">
    ...
    <div class="untree_co-section">
        <div class="container">
                                    ...
                                    <a
                                        ...
                                        <div class="row gutter-v2 gallery">
                                            <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                                ...
                                                @else
                                                    <img src="{{ asset($value->pengelolawisata['logo']) }}"
                                                        alt="Image" class="image2">
                                                @endif
                                            </div>
            ...
            <div class="center mb-5">
                <a href="{{ route('halamanpaket') }}" class="btn btn-primary" style="text-transform: uppercase">
                    {{ GoogleTranslate::trans('Wisata lainnya', session()->get('language') ?? 'id') }}
                </a>
            </div>
        </div>
    </div>
