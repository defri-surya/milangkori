...
<head>
    ...
    <title>milangkori || {{ GoogleTranslate::trans('Registrasi Wisatawan', session()->get('language') ?? 'id') }}
    </title>
            ...
            <div id="register" class="tab-pane active">
                <form method="POST" action="{{ route('register') }}" class="form-signin">
                    ...
                    <p class="muted text-center">
                        {{ GoogleTranslate::trans('Daftarkan akun Anda sebagai Wisatawan', session()->get('language') ?? 'id') }}
                    </p>
