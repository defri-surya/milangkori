                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mx-auto">
                                            <span
                                                style="font-size:15px; text-transform:uppercase;"><b>{{ $lok->judul }}</b></span>
                                        </div>
                                    </div>
                                    <img src="{{ asset($lok->perusahaan['logo']) }}" alt="Image" class="img-fluid my-3"
                                    ...
                                    <div class="center">
                                        @if ($lok->status_publish == '0')
                                            <a href="{{ route('detailloker', $lok->kode_loker) }}"
